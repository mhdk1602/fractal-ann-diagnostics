...
def _host_tools(root: Path = Path("/private/tmp/fractal-controlled")) -> PhaseHostToolContract:
    ...
    return PhaseHostToolContract(
        ...
        python_import_root=str(root / "venv/lib/python3.12/site-packages"),
        python_import_tree_sha256=_digest("python-import-tree"),
        python_launcher_sha256=REGISTERED_HOST_PYTHON_LAUNCHER_SHA256,
        python_package_content_sha256=_digest("python-package-content"),
        python_package_tree_sha256=_digest("python-package-tree"),
        python_package_source_commit="e" * 40,
...
def test_host_verifier_rejects_venv_escape_through_symlinked_parent(
    ...
    contract = replace(
        ...
        python_import_root=str(root / "escape/venv/lib/python3.12/site-packages"),
